...
function saleDate(){
  ...
  const minutes = document.getElementsByClassName("time")[1];
  const seconds = document.getElementsByClassName("time")[2];
...
function SecondSaleDate(){
  ...
  const secondMinutes = document.getElementsByClassName("timeTimer")[1];
  const secondSeconds = document.getElementsByClassName("timeTimer")[2];
  const secondFinishDate = new Date(2025, 11, 31);
